...
function NavBar() {
  return (
    <nav className="absolute top-0 left-0 w-full z-20 py-2 sticky bg-transparent border-b border-gray-700">
      <div className="container flex items-center gap-24">
        <h2 className="text-xl font-bold tracking-widest">JetDev</h2>
        <ul className="hidden md:flex items-center gap-12 font-light">
          <li>
